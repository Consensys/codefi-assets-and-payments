...
describe('TokensERC721DeployedListener', () => {
  ...
  let listener: TokenERC721DeployedListener
  ...
  beforeEach(() => {
    ...
    listener = new TokenERC721DeployedListener(
      loggerMock,
      tokensServiceMock,
  ...
  describe('eventName', () => {
    it('success', async () => {
      ...
      expect(eventName).toBe('CodefiERC721Deployed(string,string)')
    })
  })
