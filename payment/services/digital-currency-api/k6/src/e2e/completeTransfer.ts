...
export const options = {
  ...
  operationsAmount: __ENV.OPERATIONS_AMOUNT || '1000',
  ...
  transferAmount: 1, // how many digital assets should be sent
...
export default function (params) {
  ...
  group('Sender: transfer currencies', function () {
    ...
    transferIds = transferDigitalCurrencyBatch(
      ...
      parseInt(options.operationsAmount, 10),
  ...
  group('Sender: check holder balance', function () {
    ...
    check(holder, {
      'Sender: correct balance': (holder) =>
        parseInt(holder.balance, 16) === expectedBalance,
    })
  })
  ...
  group('Receiver: check holder balance', function () {
    ...
    check(holder, {
      'Receiver: correct balance': (holder) =>
        parseInt(holder.balance, 16) === transferredAmount,
    })
  })
}
