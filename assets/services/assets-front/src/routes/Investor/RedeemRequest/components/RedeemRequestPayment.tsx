...
import { RedeemRequestSummary } from './RedeemRequestSummary';
...
export const RedeemRequestPayment: React.FC<IProps> = ({
  history,
  match: {
    params: { orderId },
  },
    ...
    () => {
      const loadData = async () => {
        try {
          ...
          const redemptionCycle = (token.cycles || []).find(
            (c) => c.id === order.objectId,
          );

          setCycle(redemptionCycle);
    ...
    <OrderSplitScreenLayout>
                ...
                appModalData({
                  ...
                  confirmAction: () =>
                    ...
                    validatePayment(order, {
                      ...
                      docId: wireTransferConfirmation.docId,
                    }),
      ...
      <OrderSplitScreenSideBar>
        <RedeemRequestSummary
          ...
          assetType={assetType}
          cycle={cycle as AssetCycleInstance}
        />
      </OrderSplitScreenSideBar>
    </OrderSplitScreenLayout>
  );
