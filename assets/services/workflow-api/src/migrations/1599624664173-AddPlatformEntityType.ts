...
export class AddPlatformEntityType1599624664173 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        CREATE TYPE entitytype_enum AS ENUM ('TOKEN', 'ASSET_CLASS', 'ISSUER', 'ADMIN', 'PROJECT', 'PLATFORM');
        ALTER TABLE public.workflow_instance
