...
export class AddUnderwriterUserType1602601753130 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ...
            ALTER COLUMN "userType" TYPE VARCHAR(255);
            DROP TYPE IF EXISTS public."enum_users_userType";
            CREATE TYPE "enum_users_userType" AS ENUM ('SUPERADMIN', 'ADMIN', 'ISSUER', 'INVESTOR', 'VEHICLE', 'NOTARY', 'VERIFIER', 'NAV_MANAGER');
            ALTER TABLE public.users
            ALTER COLUMN "userType" TYPE public."enum_users_userType" USING ("userType"::text::public."enum_users_userType");
        `);
  }
