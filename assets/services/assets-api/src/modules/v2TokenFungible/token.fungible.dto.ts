...
export class CreateFungibleTokenBodyInput {
  @ApiProperty({
    description: `Must be a valid fungible token standard: ${SmartContract.ERC20_TOKEN}`,
    example: SmartContract.ERC20_TOKEN,
  })
  @IsOptional()
...
export class RetrieveFungibleTokenQueryInput {
  @ApiProperty({
    description:
...
export class RetrieveFungibleTokenParamInput {
  @ApiProperty({
...
export class RetrieveFungibleTokenOutput {
  @ApiProperty({
    description: 'Retrieved fungible token',
...
export class UpdateFungibleTokenParamInput {
  @ApiProperty({
...
export class UpdateFungibleTokenBodyInput {
  @ApiProperty({
...
export class UpdateFungibleTokenOutput {
  @ApiProperty({
    description: 'Updated fungible token',
...
export class MintFungibleTokenParamInput {
  @ApiProperty({
...
export class MintFungibleTokenBodyInput {
  @ApiProperty({
    description:
...
export class TranferFungibleTokenParamInput {
  @ApiProperty({
...
export class TransferFungibleTokenBodyInput {
  @ApiProperty({
    description:
      '[OPTIONAL] Idempotency key (shall be unique and generated on client side), used to ensure object is not created twice',
    example: ActionExample[ActionKeys.IDEMPOTENCY_KEY],
...
export class BurnFungibleTokenParamInput {
  @ApiProperty({
...
export class BurnFungibleTokenBodyInput {
  @ApiProperty({
    description:
      '[OPTIONAL] Idempotency key (shall be unique and generated on client side), used to ensure object is not created twice',
    example: ActionExample[ActionKeys.IDEMPOTENCY_KEY],
