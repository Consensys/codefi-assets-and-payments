...
import { KYCWorkflowIssuerRelatedService } from './kyc.workflow.issuer.service';
...
@Module({
  controllers: [KYCWorkflowIssuerRelatedController],
  providers: [KYCWorkflowIssuerRelatedService],
  imports: [
    V2KYCWorkflowModule,
    V2WalletModule,
    V2LinkModule,
...
export class V2KYCWorkflowIssuerRelatedModule {}
